...
intro += '# Fortress.js\n\n';
intro += '## Introduction\n\n';
intro += '[Fortress.js](https://github.com/jetfuelfinance/fortress-js) is a ';
intro += 'JavaScript SDK for BSC and the Fortress Protocol. It wraps ';
...
intro += ' message in the Development channel of the Fortress Discord.\n\n';
intro += '</section>\n\n';
