 ...
 * @example
 * ```
 * const fBnbAddress = Fortress.util.getAddress(Fortress.fBNB);
 * 
 * (async function() {
 * 
 ...
 *   );
 * 
 *   console.log('fBNB market supply rate per block:', srpb.toString());
 * 
 * })().catch(console.error);
 * ```
 */
 ...
 * const fBnbAddress = '0x4ddc2d193948926d02f9b1fe9e1daa0718270ed5';
 * const provider = window.ethereum;
 * 
 * (async function() {
 *   console.log('Supplying BNB to the Fortress Protocol...');
 * 
 *   // Mint some fBNB by supplying BNB to the Fortress Protocol
...
/**
 * This helps the Fortress.js constructor discover which Ethereum network the
 ...
 * (async function () {
 * 
 *   balance = await Fortress.eth.getBalance(myAddress, provider);
